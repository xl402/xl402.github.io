...
published: true
---
(`$\approx$` 30min) This post covers the in-depth theory regarding the EM algorithm, with python implementation for a Gaussian Mixture Model from scratch. **Only proceed if you have a free afternoon.**
{: .lead}
<!–-break-–>
